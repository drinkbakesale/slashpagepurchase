...
const FlavorForm = () => {
  ...
  function buildShopifyCartUrl(cartItems) {
    ...
    return `${baseUrl}/discount/Textsignup10?redirect=/cart/${queryString}&utm_source=swipesU&utm_medium=swipesU`;
  }
        ...
        <div className="flex flex-col gap-1">
          ...
          >
            <p className="ml-5 mt-2">
              Starting with this month’s flavor, Frosted Sugar Cookie Liquor, each
